"""
URL configuration for backend_coin project.
...
handler404 = "backend_coin.error_views.error_404"  # page_not_found
handler500 = "backend_coin.error_views.error_500"  # server_error
